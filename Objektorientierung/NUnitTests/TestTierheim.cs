...
namespace TestTierheim
{
    public class TestTierheim
    {
        ...
        [Test]
        public void GetAverageAge_Add2Animals_ReturnsCorrectAverageAge()
        {
            var myTierheim = new Tierheim();
        ...
        [Test]
        public void GetAverageAge_Add0Animals_ReturnsCorrectAverageAge()
        {
            var myTierheim = new Tierheim();
            ...
            Assert.AreEqual(0, averageAge, 0.01, "Das Durchschnittsalter sollte 6.5 Jahre betragen.");
        }
    }
